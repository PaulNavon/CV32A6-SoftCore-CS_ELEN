...
set_property -name {STEPS.SYNTH_DESIGN.ARGS.SHREG_MIN_SIZE}            -value {24} -objects [get_runs synth_1]
...
set_property STEPS.SYNTH_DESIGN.ARGS.CONTROL_SET_OPT_THRESHOLD 64 [get_runs synth_1]
